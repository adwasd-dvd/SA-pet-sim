...
const requiredAppSnippets = [
  ...
  ["assist NPC route drops stale Worker response", "endAssistRoute(\"npc\", npc.id);"],
  ["NPC auto-go preserves visible busy state", "followRouteTo(approach.target, approach, { label: npc.name, preserveAssistRoute: true, walkSlotTimeoutMs: ASSIST_ROUTE_START_TIMEOUT_MS })"],
  ["exit auto-go preserves visible busy state", "followRouteTo(approach.target, approach, { label: exit.label, preserveAssistRoute: true, walkSlotTimeoutMs: ASSIST_ROUTE_START_TIMEOUT_MS })"],
