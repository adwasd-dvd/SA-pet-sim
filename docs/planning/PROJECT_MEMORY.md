...
- `client-ui-002` has started: the map now has an original-client-style command dock for pet/task/log/save/data/AI panels, giving the player in-map controls instead of relying only on the right-side dashboard tabs.
